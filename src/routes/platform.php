...
use App\Orchid\Screens\SystemMessageEditScreen;
use App\Orchid\Screens\SystemMessagesScreen;
...
// Platform > Profile
Route::screen('system-messages', SystemMessagesScreen::class)
	->name('platform.system-messages')
	->breadcrumbs(fn(Trail $trail) => $trail
			->parent('platform.index')
			->push(__('System Messages'), route('platform.system-messages')));

// Platform > System > Users > User
Route::screen('system-messages/{system_message}/edit', SystemMessageEditScreen::class)
	->name('platform.systems.system-message.edit')
	->breadcrumbs(fn(Trail $trail, $systemMessage) => $trail
			->parent('platform.system-messages')
			->push(__('System Messages'), route('platform.system-messages')));

// Platform > System > Users > Create
Route::screen('system-messages/create', SystemMessageEditScreen::class)
	->name('platform.systems.system-message.create')
	->breadcrumbs(fn(Trail $trail) => $trail
			->parent('platform.system-messages')
			->push(__('System Messages'), route('platform.system-messages')));
